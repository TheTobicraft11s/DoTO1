...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/doto-ark-thetobicraft#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/doto-ark-thetobicraft
```

A live public deployment of this template is available at [https://doto-ark-thetobicraft.templates.workers.dev](https://doto-ark-thetobicraft.templates.workers.dev)
